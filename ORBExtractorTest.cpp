...
int main(int argc, char** argv)
{
    ...
    */
    ...
    rgbRectifyImageL = rgbRectifyImageL(Rect(50, 50, imageWidth - 100, imageHeight - 100));
    rgbRectifyImageR = rgbRectifyImageR(Rect(50, 50, imageWidth - 100, imageHeight - 100));
